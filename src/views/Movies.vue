                ...
                <div class="col">
                    <div class="d-flex">
                        <select v-model="ratingToSearch" class="form-select">
                            <option value="" disabled selected>Select by Rating</option>
                ...
                <div v-for="movie in movies" class="col" :key="movie._id">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <router-link :to="'/movie/' + movie._id" class="btn btn-primary">View Reviews</router-link>
                        </div>
                    </div>
                </div>
            </div>
    ...
    methods: {
        async getMovies() {
            ...
            this.totalPages = Math.ceil(
                moviesData.total_result / this.entriesPerPage
            ) - 1;
